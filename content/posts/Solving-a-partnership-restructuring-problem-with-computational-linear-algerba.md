...
Consider a partnership restructuring its assets into majority ownerships, with N partners currently sharing all of the business’s M assets at uneven stake. To minimize possible restructuring taxes, I aim to re-distribute the assets without altering each partner's overall value and debt stake in the business. In application, we used a Markov model to exhaustively search for solutions to a three partner/eleven asset problem, testing over 200 million potential restructuring states. The optimal solution incurred a 2.9mm cumulative stake change against 159mm in total assets, an acceptably small magnitude of change (<2%) that allows the business to effectively avoid a large restructuring tax.
